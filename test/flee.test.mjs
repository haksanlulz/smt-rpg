...
//
// p.70, verbatim: "PCs may attempt to escape from any non-Boss encounter... opposing
// combatants may decide whether they wish to block the attempt or not. If no combatant
// chooses to block the attempt, then fleeing is automatically successful. If all members
// of one side flee, then combat ends."
//
