...
//
// p.70, verbatim: "To make an encounter check, all PCs make a Luck check, then consult
// the following chart to find their overall value and ultimately what situation occurs."
//
